...
import {GetSortedTasks, SetChangedTasks} from './Components/Utils/ChangeHelper';
...
class App extends Component {
    ...
    render() {
        const {
            generalListOfTasks, changedListOfTasks, selectedIds, filterTasksBy, isLoading, currentPage, tasksCount,
            searchedText
        } = this.state;
